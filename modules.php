<?php
   ...
   if (isset($_SESSION['id'])) {
      ...
      $data['content'] .= "<thread><tr><th>Code</th><th>Type</th><th>Level</th></tr></thread>";
      // Display the modules within the html table
      while($row = mysqli_fetch_array($result)) {
         $data['content'] .= "<tbody><tr><td> $row[modulecode] </td><td> $row[name] </td>";
         $data['content'] .= "<td> $row[level] </td></tr></tbody>";
      }
      $data['content'] .= "</table>";
